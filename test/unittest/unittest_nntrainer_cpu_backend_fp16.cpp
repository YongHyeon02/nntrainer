...
TEST(nntrainer_cpu_backend_standalone,
  ...
  const auto stats = nntrainer::x86::testing::get_hgemm_workspace_stats();
...
template <typename SrcT> static void run_packing_B_N16_trans_test() {
  ...
  nntrainer::x86::packing_B_N16_trans(K, N, src.data(), stride, dst.data());
...
TEST(nntrainer_cpu_backend_standalone,
  ...
  auto alpha_zero_stats = nntrainer::x86::testing::get_hgemm_workspace_stats();
